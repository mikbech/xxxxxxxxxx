...
if(isset($_POST["id"]) && !empty($_POST["id"])){
   ...
   // Validate address
    ...
    if(empty($input_appointment)){
        $address_err = 'Please enter an appointment.';     
    } else{
    ...
    if(empty($name_err) && empty($course_err) && empty($appointment_err)){
        ...
        $sql = "UPDATE appointment SET name=:name, course=:course, appointment=:appointment WHERE id=:id";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($appointment_err)) ? 'has-error' : ''; ?>">
